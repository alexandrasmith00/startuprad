...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <style type="text/css">
      ...
      html{width: 100%; }
      body{width:100% !important; -webkit-text-size-adjust:100%; -ms-text-size-adjust:100%; margin:0; padding:0; color:#5F666C;}
  ...
  <body>
    ...
    <table width="100%" bgcolor="#fcfcfc" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="header">
      <tbody>
        <tr>
          <td>
            <table style="border-collapse:collapse; border-bottom: 2px solid #0D74FE;" width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
              <tbody>
                <tr>
                  <td width="100%">
                    <table width="600"  cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #323A45; text-align:left; line-height: 24px; padding-left: 25px;">
                                    Hi <?php echo e($user->first); ?>,<br><br>

                                    Welcome to startuprad.com! Please visit the link below to confirm your email and set up your account. You will be asked to set a password for your RAD account. <br><br>

                                    <a style="color: #0D74FE;" href="<?php echo e($link = url('confirm', $token).'?email='.urlencode($email)); ?>"> <?php echo e($link); ?> </a><br><br>
                                ...
                                <tr>
                                  <td height="14" align="center" valign="middle" style="font-family: Helvetica, Arial, sans-serif; font-size: 13px; font-weight:bold;color: #ffffff; text-align:center; line-height: 14px; ; -webkit-text-size-adjust:none;" st-title="fulltext-btn">
                                    <a style="text-decoration: none;color: #fff; text-align:center;" href="#">Reset</a>
                                  </td>
                                </tr>
                                <!-- End of content -->
                                <!-- Spacing -->
