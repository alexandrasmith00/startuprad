...
<div class="row">
  <div class="col-md-8 col-md-offset-2 col-sm-12">
    ...
    <div class="widget-wrap">
      ...
      <?php echo $__env->make('projects.sections.general', ['edit' => true ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      <hr style="margin-top: 25px; margin-bottom: 25px;">

      <?php echo $__env->make('projects.sections.social', ['edit' => true ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      <hr style="margin-top: 25px; margin-bottom: 25px;">
      ...
      <?php echo $__env->make('projects.sections.strategy', ['edit' => true ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
