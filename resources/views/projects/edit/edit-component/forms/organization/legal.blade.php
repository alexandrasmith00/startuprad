  ...
  <div class="row">
    ...
    <div class="col-sm-8 col-xs-12">
      <div style="padding-left: 0px;" class="col-xs-6">
        <input data-parsley-required type="text" class="form-control input-one" name="first" placeholder="First" value="{{ $idea->legalStatus() }}">
      </div>
...
<h1>{{ breakLegalStatus("Massachusetts LLC") }}</h1>
