                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #323A45; text-align:left; line-height: 24px; padding-left: 25px;">
                                    ...
                                    <b>{{ $startup }}</b> has applied to join Startup RAD.  Here is a copy of the application.  As a reminder, you can view all applications by visiting the admin dashboard<br><br>
                                  </td>
                                </tr>
                                <tr>
