<div class="widget-wrap stats-widget">
    ...
    <h3 class="profile-username text-center">{{ $this_profile->name->value }}</h3>
    <p class="text-muted text-center">{{ $this_profile->tagline->value }} </p>
    <p class="text-muted text-center"><a href="{{ $this_profile->site->value }}">{{ $this_profile->site->value }} </a></p><br>
