...
<button id="click-post" name="click-post" class="btn btn-link btn-block btn-loadmore" style="padding: 6px 12px;"><i class="zmdi zmdi-comment-alt-text"></i> &nbsp;{{ $action }}</button>
</form>
