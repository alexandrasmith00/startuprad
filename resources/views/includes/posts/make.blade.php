...
<!--
  ...
  <div class='box-header with-border'>
    <div class='user-block'>
      <img class='img-circle' src="{{{ Auth::user()->profile_picture != "" ? Auth::user()->profile_picture : 'http://www.startuprad.com/assets/images/db414718.default_no_profile.jpg' }}}" alt='user image'>
      <span class='username'><a href="/project/{{ Auth::user()->idea->id }}">{{ Auth::user()->idea->name }}  </a><small class="text-muted">{{ Auth::user()->name }}</small> </span>
